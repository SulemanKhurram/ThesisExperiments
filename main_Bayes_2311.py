...
def test(epoch):
    ...
    print("f1_score:" + f1_score(y.data, predicted, average="macro"))
    utils.writeLogs("f1_score:" + f1_score(y.data, predicted, average="macro"))
    print("precision:" + precision_score(y.data,predicted, average="macro"))
    utils.writeLogs("precision:" + precision_score(y.data,predicted, average="macro"))
    print("recall : " + recall_score(y.data, predicted, average="macro"))
    utils.writeLogs("recall : " + recall_score(y.data, predicted, average="macro"))
    fpr, tpr, thresholds = roc_curve(y.data, predicted)

    roc_auc = auc(y.data, predicted)

    print("False positive" + fpr)
    utils.writeLogs("False positive" + fpr)
    print("True positive" + tpr)
    utils.writeLogs("True positive" + tpr)
    print("Thresholds" + thresholds)
    utils.writeLogs("True positive" + thresholds)

    print("ROC_AUC" + roc_auc)
    utils.writeLogs("ROC_AUC" + roc_auc)
