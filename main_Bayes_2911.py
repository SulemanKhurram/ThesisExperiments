...
from utils.BayesianModels.BayesianAlexNet3Conv1FC import BBBAlexNet
...
def test(epoch):
    ...
    print(predicted)
    print(y.data)
    print("overall f1_score:" + str(f1_score(y.data, predicted, average="macro")))
    utils.writeLogs("overalll f1_score:" + str(f1_score(y.data, predicted, average="macro")))
    print("overall precision:" + str(precision_score(y.data,predicted, average="macro")))
    utils.writeLogs("overall precision:" + str(precision_score(y.data,predicted, average="macro")))
    print("overall recall : " + str(recall_score(y.data, predicted, average="macro")))
    utils.writeLogs("overall recall : " + str(recall_score(y.data, predicted, average="macro")))
    ...
    print(classification_report(y.data, predicted, target_names=target_names, digits=4))
    utils.writeLogs(str(classification_report(y.data, predicted, target_names=target_names, digits=4)))
